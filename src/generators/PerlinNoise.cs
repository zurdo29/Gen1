...
namespace ProceduralMiniGameGenerator.Generators
{
    ...
    public class PerlinNoise
    {
        ...
        public PerlinNoise()
        {
            ...
            for (int i = 0; i < 256; i++)
            {
                _p[i] = _p[i + 256] = _permutation[i];
            }
        }
        
        /// <summary>
        /// Sets the seed for the noise generation by shuffling the permutation table
        /// </summary>
        public void SetSeed(int seed)
        {
            ...
            // Update the doubled permutation table
            for (int i = 0; i < 256; i++)
            {
                _p[i] = _p[i + 256] = _permutation[i];
            }
        ...
        /// <summary>
        /// Gradient function that converts hash code into a gradient vector
        /// </summary>
