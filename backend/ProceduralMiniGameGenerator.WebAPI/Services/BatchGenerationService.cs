    ...
    public class BatchGenerationService : IBatchGenerationService
    {
        ...
        public async Task ProcessBatchGenerationAsync(string jobId, BatchGenerationRequest request)
        {
            ...
            try
            {
                ...
                await _jobStatusService.UpdateJobStatusAsync(jobId, JobStatusType.Running, 5, "Starting batch generation");
                ...
                await _jobStatusService.UpdateJobStatusAsync(jobId, JobStatusType.Running, 10, "Configuration validated");
